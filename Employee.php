...
class Employee {
	...
	public function insertEmployee($conn){
		...
		$stmt = $conn->prepare("INSERT INTO employee (employee_id, name, address_line_1, address_line_2, city, state, zip, main_phone, alt_phone, is_full_time)
								VALUES	(:employee_id, :name, :address_line_1, :address_line_2, :city, :state, :zip, :main_phone, :alt_phone, :is_full_time)");
